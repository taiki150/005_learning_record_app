                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <input
                                                id="learning-date"
                                                type="date"
                                                className="h-9 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm text-slate-900 outline-none ring-0 transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100 peer-checked:hidden"
                                            />
                            ...
                            <div className="space-y-2 sm:col-span-1">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="grid grid-cols-4 gap-2">
                                        <button type="button" onClick={() => setHours(0)} className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 focus:outline-none focus:ring-4 focus:ring-slate-100">0</button>
                                        <button type="button" onClick={() => setHours((h) => h + 1)} className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 focus:outline-none focus:ring-4 focus:ring-slate-100">1</button>
                                        <button type="button" onClick={() => setHours((h) => h + 2)} className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 focus:outline-none focus:ring-4 focus:ring-slate-100">2</button>
                                        <button type="button" onClick={() => setHours((h) => h + 4)} className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 focus:outline-none focus:ring-4 focus:ring-slate-100">4</button>
                                    </div>
                                </div>
                            </div>
